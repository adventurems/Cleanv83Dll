...
#pragma region Existing Skill Changes
	...
	// Set Aran combo uptime to 5000 milliseconds (5 seconds) - Crabo
	...
	// Change Knockback Distance for all skills 700 (300 Default) - Pepa / Teto
...
#pragma region Maker Changes
	...
	Memory::WriteByte(0x005CA1B8 + 2, 0x32); // Purple color on scrolled item (+50 stats)
	Memory::WriteByte(0x005CA5FA + 2, 0x64); // Yellow color on scrolled item (+100 stats)
...
#pragma endregion
	...
	//1H Axe/BW multipliers (change 3.2 to 3.6) - Crabo
	...
	//2H Axe/BW (change 3.4 to 4.4) - Crabo
	...
	// Speed Cap Removal - 400 Max - General
...
#pragma region AdventureMS Quality of Life
	...
	// Allow password length beyond 12 (20 is set) - Mr.Dead
	...
	// Force Windowed Mode and Skip Logos - Ezorsia
